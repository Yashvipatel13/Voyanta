...
import { Compass, Sparkles, Bookmark, Heart, User, LogOut, LogIn, Menu, X } from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/80 transition-all shadow-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 py-2">
          ...
          {/* Notifications & Profile / Sign In Section */}
            ...
            {isAuthenticated ? (
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-2 text-sm font-medium text-slate-700 hover:text-slate-900 transition-colors"
                >
                  <User className="w-4 h-4 text-slate-400" />
                  <span>Sign In</span>
                </button>
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-blue-600 hover:bg-blue-700 text-white shadow-xs hover:shadow transition-all duration-150"
                >
                  Join Voyanta
                </button>
              </div>
